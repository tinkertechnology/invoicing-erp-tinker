...
from apps import views as default_views
from apps.views_setup.brand  import views_brand 

from apps import views_customer as my_customer
from apps import views_bill as my_bill
from apps import views_settings as my_settings
...
urlpatterns = [
    ...
    url(r'^brand$', views_brand.index, name='brand'),
    #url(r'^take_order/(?P<order_id>\d+)/$', my_order.take_order_show, name='take_order_show'),
    url(r'^brand/new/$', views_brand.new, name='brand_new'),
    url(r'^brand/edit/(?P<id>\d+)/$', views_brand.edit, name='brand_edit'),
    url(r'^brand/delete/(?P<id>\d+)/$', views_brand.destroy, name='brand_delete'), 

    url(r'^$', default_views.index, name='home'),
   ...
   #CUSTOMER 
    ...
    # url(r'^bill/(?P<bill_id>\d+)/$', my_bill.show, name='bill_show'),


   #SETTINGS

    # url(r'^settings$', my_settings.index, name='settings'),
    # #url(r'^take_order/(?P<order_id>\d+)/$', my_order.take_order_show, name='take_order_show'),
    # url(r'^settings/new/$', my_settings.new, name='settings_new'),
    # url(r'^settings/edit/(?P<id>\d+)/$', my_settings.edit, name='settings_edit'),
    # url(r'^settings/delete/(?P<id>\d+)/$', my_settings.destroy, name='settings_delete'), 
